                ...
                {step === 5 && (
                  <div className="space-y-5">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Add image URLs to make your listing stand out</p>
                    </div>

                    <div className="rounded-xl bg-muted/40 border border-border/50 p-4 text-sm text-muted-foreground">
                      <p className="font-medium text-foreground mb-1">📸 How to add images</p>
                      <p>Upload your photos to <a href="https://imgur.com" target="_blank" rel="noreferrer" className="text-primary underline">Imgur</a>, <a href="https://imgbb.com" target="_blank" rel="noreferrer" className="text-primary underline">ImgBB</a>, or Google Photos (share link), then paste the URL below. Images are optional — we'll use a default based on your category.</p>
                    </div>

                    <FieldGroup label="Business Logo / Profile Image">
                      <Input
                        type="url"
                        placeholder="https://i.imgur.com/yourlogo.jpg"
                        value={formData.imageUrl}
                        onChange={e => set("imageUrl", e.target.value)}
                      />
                      {formData.imageUrl && (
                        <div className="mt-2 w-16 h-16 rounded-xl overflow-hidden border border-border">
                          <img src={formData.imageUrl} alt="logo preview" className="w-full h-full object-cover" onError={e => (e.currentTarget.style.display = "none")} />
                        </div>
                      )}
                    </FieldGroup>
                    ...
                    <FieldGroup label="Cover / Banner Image">
                      <Input
                        type="url"
                        placeholder="https://i.imgur.com/yourcover.jpg"
